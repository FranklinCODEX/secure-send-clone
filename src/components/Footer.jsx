            ...
            <div className="container mx-auto">
                <div className="grid lg:grid-cols-6 grid-cols-2  gap-5">
                        <div className="flex flex-col col-span-2 gap-5 w-full " >
                                ...
                                <p className="lg:w-[80%] w-full " >Discover more about our mission, vision, and values as we work to simplify global payments for businesses and individuals.</p>
                ...
                <div className="flex items-center justify-center " >
                    <div className="h-6 lg:w-[60%] w-full flex items-center justify-center " >
